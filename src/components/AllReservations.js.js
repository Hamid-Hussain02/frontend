        ...
        <TableBody>
          {reservations.reservations.map((reservation) => (
            ...
            >
              ...
              <TableCell align="center">
                {reservation.bill_id ? reservation.bill_id : "-"}
              </TableCell>
              <TableCell
                align="center"
                onClick={() => updateBill(reservation.Bill)}
              >
                <Modal />
              </TableCell>
              <TableCell align="center">
                {getDate(reservation.createdAt ? reservation.createdAt : "-")}
              </TableCell>
            </TableRow>
          ))}
        </TableBody>
